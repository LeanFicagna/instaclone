<nav class="navbar navbar-expand-lg navbar-light bg-light">
    <div class="container-fluid">
        <a class="navbar-brand fs-1" href="{{ route('home') }}">LinstaClone</a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <form class="d-flex bar-search" method="post" action="{{ route('search') }}">
                @csrf
            ...
            <div class="icons">
                ...
                <a class="icon" data-toggle="modal" href="#" data-bs-toggle="modal" data-bs-target="#exampleModal">
                ...
                <a class="icon" href="/user/{{ Auth::user()->user }}">
...
<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <form class="modal-dialog" method="POST" action="{{ route('publication') }}" enctype="multipart/form-data">
        @csrf
        <div class="modal-content">
            ...
            <div class="modal-body">
                <input type="text" name="descript" id="descript" class="form-control" placeholder="Descrição">
                <label for="img">
                ...
                <input type="text" name="user_id" id="user_id" value="{{ Auth::user()->id }}" class="d-none">
            </div>
